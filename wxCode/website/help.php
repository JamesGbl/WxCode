...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
    ...
    <ol>
    <li>Give a look at the <a href="http://wxcode.cvs.sourceforge.net/wxcode/wxCode/components/">CVS</a> or the <a href="http://wxcode.svn.sourceforge.net/viewvc/wxcode/trunk/wxCode/components/">Subversion</a> repository of the component you want to maintain: be sure to be able to understand the work of the original author of the code so that you can make bugfixes and improvements...</li>
    <li>Send a message to <a href="mailto:wxcode-users@lists.sourceforge.net">wxCode-users mailing list</a> saying that you would be interested to take over the maintainance of component X. Eventually provide a short list of the modifications you think that the component needs (in order to update it to the latest wxWidgets version, etc...).</li>
