...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
    ...
    <p id="1" class="question">1) Can I access the components from CVS or Subversion ?</p>
    <p class="answer">Sure! You just need a configured CVS client, see <a href="http://sourceforge.net/cvs/?group_id=51305">this Sourceforge CVS doc</a>, or a configured Subversion client, see <a href="http://sourceforge.net/svn/?group_id=51305">this Sourceforge CVS doc</a>.
    When reading both documents, refer to the &quot;About&quot; and &quot;Anonymous access&quot; sections. Our suggested CVS and Subversion clients are <a href="http://www.tortoisecvs.org/">TortoiseCVS</a> and <a href="http://tortoisesvn.tigris.org/">TortoiseSVN</a>.</p>

    <p class="answer">Please note that you can also browse the CVS/Subversion repository of a component online just following the links in the <a href="complist.php">component list page</a> and that each component is <em> either</em> in the CVS repository or in the Subversion one, not in both.</p>


    <p id="2" class="question">2) What is the best way to get or use the wxCode components ?</p>
    <p class="answer">It is recommended that you use CVS to get a copy of wxCode or just the individual components you use. Doing it this way places all the components in the same place, making it easier for you to use them in your own project.</p>
    ...
    <ol>
    <li>If you haven't already done so, get the <strong>CVS</strong> repository of the component (or the <strong>Subversion</strong> one if the component is using Subversion instead of CVS, i.e. has a 'Browse Subversion' link instead of a 'Browse CVS' link in its description). Look at FAQ #1 for more details.</li>

    <li>Under <strong>Windows</strong> you can tipically use your CVS/Subversion's &quot;Patch&quot; function (e.g. for TortoiseCVS and TortoiseSVN you can right-click the component's folder from Explorer and choose &quot;Make patch&quot; or similar); save the patch somewhere (e.g. on the desktop) with a sensible name (possibly with extension .patch).<br/><br/>

    Under <strong>Unix</strong>-like operating systems, open a &quot;terminal&quot; and type:
        <pre class="sourcecode">cvs diff -bu2 >mypatch.patch</pre> (if you checked out the CVS repository)
    or
        <pre class="sourcecode">svn diff --diff-cmd="diff" --extensions="-buw" >mypatch.patch</pre> (if you checked out the SVN repository)
    </li>
    ...
    <li>Since wxCode contains a number of components, people can pick and choose among them. If they use CVS, they won't have to download each package individually and deal with the hassle of managing them separately.</li>
    ...
    <p id="7" class="question">7) How can I access the CVS repository for my component ? How can I make a release for my component ? How can I make the website for my component ? How can I add a Bakefile-based build system to my component ?</p>
    <p class="answer">See the <a href="maintguide.php">wxCode maintainer guide</a> and eventually ask for help in the <a href="http://lists.sourceforge.net/lists/listinfo/wxcode-users">wxCode-users mailing list</a>...</p>
